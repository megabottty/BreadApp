...
-- 9. Disable Row Level Security (RLS) on all tables (temporarily for development)
ALTER TABLE bakery_tenants DISABLE ROW LEVEL SECURITY;
ALTER TABLE bakery_recipes DISABLE ROW LEVEL SECURITY;
ALTER TABLE bakery_orders DISABLE ROW LEVEL SECURITY;
ALTER TABLE bakery_reviews DISABLE ROW LEVEL SECURITY;
ALTER TABLE bakery_subscriptions DISABLE ROW LEVEL SECURITY;
ALTER TABLE bakery_promos DISABLE ROW LEVEL SECURITY;
ALTER TABLE bakery_inventory DISABLE ROW LEVEL SECURITY;
ALTER TABLE bakery_audit_logs DISABLE ROW LEVEL SECURITY;
